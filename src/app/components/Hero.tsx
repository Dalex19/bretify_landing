...
export default function Hero() {
  return (
    <div className="h-[75vh]  md:h-[83vh] px-4 md:py-8 md:px-16 gap-4 md:gap-6 grid grid-row-6 md:grid-cols-4 md:grid-rows-3 ">
      <div className="bg-[#E1E2F3] text-black row-span-2 md:row-span-2 md:col-span-2 rounded-2xl flex flex-col justify-around p-5">
        <h1 className="text-lg leading-4 md:leading-[2.4rem] md:text-5xl font-clashDisplay">
       ...
       <div className="hidden md:flex md:justify-center bg-[#141414] md:row-span-3 md:col-span-2 rounded-2xl relative ">
        <PhoneMockup />
      </div>
      ...
      <div className=" row-span-1  bg-[#F97D36] col-span-1 rounded-2xl text-black flex flex-col items-center justify-center">
        ...
        <p className="md:-rotate-2">Busca menos, encontra más</p>
        </div> 
